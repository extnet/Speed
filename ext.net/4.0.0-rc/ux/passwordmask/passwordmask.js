...
else{this.getCmp().setValue(this.hiddenField.getValue());}},destroy:function(){this.callParent(arguments);this.hiddenField.destroy();},renderHiddenField:function(){var field=this.getCmp();if(field.ownerCt){field.ownerCt.items.add(this.hiddenField);}else{this.hiddenField.render(field.el.parent());}
