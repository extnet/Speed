...
Ext.define('Ext.ux.form.MultiSelect', {
    ...
    setupItems: function () {
        ...
        me.boundList = new Ext.view.BoundList(Ext.apply(config, me.listConfig));
...
Ext.define('Ext.ux.TabReorderer', {
    ...
    boxItemSelector: '.' + Ext.baseCSSPrefix + 'tab',
...
Ext.define('Ext.ux.desktop.TaskBar', {
    ...
    initComponent: function () {
        ...
        me.items = [
            ...
            me.quickStart,
            {
                ...
                listeners: {
                    "afterrender": function(){
                        this.tracker.onDrag = Ext.Function.createSequence(this.tracker.onDrag, this.splitterPerformResize, this.tracker);
                    }
                }
            },
            //'-',
    ...
    splitterPerformResize : function (e) {
        this.performResize(e, this.getResizeOffset());
    },
...
Ext.define('Ext.ux.desktop.Desktop', {
    ...
    showTip : function () {
        ...
        if(!Ext.isEmpty(record.get('qTitle'))){
            ...
            this.tip.header.removeCls("x-hidden-display");
        }
        else if(this.tip.header){
            this.tip.header.addCls("x-hidden-display");
        }
...
Ext.define('Ext.ux.Spotlight', {
    ...
    show: function(el, callback, scope) {
        ...
        if (!me.active) {
            ...
            me.applyBounds(me.animate, false, callback, scope); // #665: added callback/scope
        } else {
            //if the spotlight is currently active, just move it
            me.applyBounds(false, false, callback, scope); // #665: added callback/scope
        }
    },
    ...
    hide: function(callback, scope) {
        ...
        me.applyBounds(me.animate, true, callback, scope); // #665: added callback/scope
    },
        ...
        if (!me.menu) {
            ...
            if (me.showCloseOthers) {
                items.push({
                    ...
                    iconCls: me.closeOtherTabsIconCls,
                    scope: me,
...
Ext.define('Ext.ux.CellDragDrop', {
    ...
    notSupportedText: "The cell from a Column without a DataIndex cannot be used for drag&drop", // #899
...
Ext.define('Ext.net.TagField', {
    ...
    setEditable: function (editable) {
        if (this.inputEl) {
            this.inputEl.setDisplayed(editable);
        }
...
Ext.define('Ext.ux.colorpick.SliderAlpha', {
    ...
    gradientStyleTpl: Ext.create('Ext.XTemplate',
        ...
        : 'background: -mox-linear-gradient(top, rgba({r}, {g}, {b}, 1) 0%, rgba({r}, {g}, {b}, 0) 100%);' +   
