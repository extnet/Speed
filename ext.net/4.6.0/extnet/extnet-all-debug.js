...
// @source core/form/FieldSet.js

// Addresses an issue with Safari 11 and fieldsets' titles/legend.
Ext.define("gh1554", {
    ...
    createLegendCt: function () {
        ...
        if (Ext.isSafari11) {
            // as suggested in the related Sencha forum thread,
            // but set selectively (only if legend is used and
            // browser is Safari 11)
