Ext.data.TreeStore.override({
    ...
    /**
     * ExtJS introduced this method as of 6.0.2 but our version supports not
     * only to reload the root node but any node specified in options
     * The default behaviour here is the same as ExtJS's.
     */
