...
event.preventDefault();me.fireEvent('beforemenu',menu,me.item,me);menu.showAt(event.getXY());},createMenu:function(){var me=this,items;if(!me.menu){items=[{itemId:'close',text:me.closeTabText,scope:me,handler:me.onClose}];if(me.showCloseAll||me.showCloseOthers){items.push('-');}
if(me.showCloseOthers){items.push({itemId:'closeOthers',text:me.closeOtherTabsText,scope:me,handler:me.onCloseOthers});}
...
Ext.define('gh1648',{override:'Ext.ux.TabCloseMenu',closeTabIconCls:null,closeOtherTabsIconCls:null,closeAllTabsIconCls:null,createMenu:function(){var me=this,items;if(!me.menu){items=[{itemId:'close',text:me.closeTabText,iconCls:me.closeTabIconCls,scope:me,handler:me.onClose}];if(me.showCloseAll||me.showCloseOthers){items.push('-');}
if(me.showCloseOthers){items.push({itemId:'closeOthers',text:me.closeOtherTabsText,iconCls:me.closeOtherTabsIconCls,scope:me,handler:me.onCloseOthers});}
